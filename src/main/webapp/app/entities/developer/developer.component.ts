...
export class DeveloperComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.developerService
        ...
        .subscribe((res: HttpResponse<IDeveloper[]>) => this.paginateDevelopers(res.body, res.headers));
      return;
    }
    this.developerService
      .query({
  ...
  trackId(index: number, item: IDeveloper) {
    return item.id;
  }
  ...
  protected paginateDevelopers(data: IDeveloper[], headers: HttpHeaders) {
