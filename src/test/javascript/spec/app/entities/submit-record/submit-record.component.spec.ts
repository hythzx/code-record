...
import { SubmitRecordComponent } from 'app/entities/submit-record/submit-record.component';
...
describe('Component Tests', () => {
  describe('SubmitRecord Management Component', () => {
    let comp: SubmitRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubmitRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.submitRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
